...
function globalVariables(){ 
  var varArray = {
    spreadsheetId   : '1B8PGBd9-Bp-cH0BHw4x3erP2qwEZJD4Q8SGN2UVKPvo', //** CHANGE !!!
    dataRage        : 'Data!A2:M',                                    //** CHANGE !!!
    idRange         : 'Data!A2:A',                                    //** CHANGE !!!
    lastCol         : 'M',                                            //** CHANGE !!!
    insertRange     : 'Data!A1:M1',                                   //** CHANGE !!!
...
/* ADD OR REMOVE VARIABLES ACCORDING TO YOUR FORM*/
  if(formObject.RecId && checkID(formObject.RecId)){
    var values = [[formObject.RecId.toString(),
                  ...
                  formObject.nospr,
                  formObject.noaset,
                  formObject.jamkerusakan,
                  formObject.tglkerusakan,
                  formObject.ttdga,
                  formObject.deskripsikerusakan,
                  formObject.penyebab,
                  formObject.provinsi,
                  formObject.kodemesin]];
  }else{
